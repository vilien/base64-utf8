;(function(){
  ...
  var dec = function(charMap) {
    return function(input) {
      var str = String(input), map = charMap.slice(0, -1), prx = [6,4,2,0],
        output = '', block = 0, code, buffer=0, hex = '';
      try {
